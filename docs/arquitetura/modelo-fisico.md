...
Esta seção apresenta o modelo físico do banco de dados do sistema Sexto Andar, incluindo o diagrama relacional e o script DDL completo.
...
<a href="../../assets/diagramas/erd.png" target="_blank">
  <img src="../../assets/diagramas/erd.png" alt="Diagrama Físico do Banco de Dados" style="max-width: 100%; height: auto; cursor: zoom-in; border: 1px solid #ccc; box-shadow: 2px 2px 8px #aaa;" />
</a>
...
Clique para visualizar o script DDL completo do banco de dados:

[Download DDL](../assets/codigos/ddl.sql)
